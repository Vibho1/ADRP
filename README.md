...
2. **LLM Gateway (NestJS):** Next.js backend that acts as the API server, routing simple tasks to smaller models (e.g., Gemini Flash) and complex reasoning to heavier models to optimize cost and performance. Implements caching.
